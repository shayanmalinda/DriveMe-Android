...
public class ParentPaymentViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_payment_view);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ParentPaymentViewActivity.this);
        ...
        db.collection("users/user/parent/"+parentId+"/payments/").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                SimpleAdapter adapter = new SimpleAdapter(ParentPaymentViewActivity.this,list,layout,cols,views);
