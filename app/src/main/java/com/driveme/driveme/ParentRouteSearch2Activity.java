...
public class ParentRouteSearch2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_route_search2);setTitle("Route Search - Results");
        Bundle extras = getIntent().getExtras();

        AlertDialog.Builder builder = new AlertDialog.Builder(ParentRouteSearch2Activity.this);
        ...
        for(final String driverId:filteredRoutes){
            ...
            db.document("users/user/driver/"+driverId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    ...
                    SimpleAdapter adapter = new SimpleAdapter(ParentRouteSearch2Activity.this,list,layout,cols,views);
    ...
    public void viewdetails(View v){
        ...
        Intent intent = new Intent(ParentRouteSearch2Activity.this,ParentRouteSearch3Activity.class);
