...
public class PassengerRouteSearch3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passenger_route_search3);
        ...
        db.collection("users/user/driver/"+driverId+"/checkpoints/").orderBy("order").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                SimpleAdapter adapter = new SimpleAdapter(PassengerRouteSearch3Activity.this,list,layout,cols,views);
