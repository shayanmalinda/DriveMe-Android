...
public class ParentRouteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_route);
        setTitle("My Route");
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ParentRouteActivity.this);
...
//                dialog2.dismiss();
                ...
                db.document("users/user/parent/"+parentId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        db.collection("users/user/parent/"+pId+"/payments").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            @Override
                        ...
                        Toast.makeText(ParentRouteActivity.this, ""+driverId, Toast.LENGTH_SHORT).show();
                        ...
                        db.document("users/user/parent/"+pId).update("driverId", FieldValue.delete());
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
    ...
    private void getCheckpoints(String driverId, final Dialog dialog){
        ...
        db.collection("users/user/driver/"+driverId+"/checkpoints").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                SimpleAdapter adapter = new SimpleAdapter(ParentRouteActivity.this,list,layout,cols,views);
